...
/**
 * ioPerson form base class.
 *
 * @method ioPerson getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseioPersonForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('io_person[%s]');
