...
/**
 * ioTimeLog filter form base class.
 *
 ...
 */
abstract class BaseioTimeLogFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('io_time_log_filters[%s]');
